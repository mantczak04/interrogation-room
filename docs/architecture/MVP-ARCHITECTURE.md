...
Pierwszy slice ma pozwolić 3–8 graczom połączyć się lokalnie, rozpocząć Rundę, otrzymać prywatne role i wersje Alibi, przejść przez Przygotowanie, swobodnie poruszać się podczas wspólnego Limitu Rundy oraz zakończyć rozgrywkę jedną Egzekucją albo upływem czasu.
...
6. Vivox positional channel i portalowa akustyka na KCP/ParrelSync; następnie test współistnienia z FizzySteamworks.
