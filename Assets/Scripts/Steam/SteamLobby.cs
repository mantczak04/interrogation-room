...
namespace InterrogationRoom.Steam
{
...
public class SteamLobby : MonoBehaviour
{
    ...
    void OnGameOverlayActivated(GameOverlayActivated_t callback)
    {
        ...
        if (overlayActive)
        {
            cursorWasReleasedBeforeOverlay = PlayerInputGate.CursorReleased;
            PlayerInputGate.SetPlayerCursorReleased(true);
            return;
        }

        PlayerInputGate.SetPlayerCursorReleased(cursorWasReleasedBeforeOverlay);
    }
