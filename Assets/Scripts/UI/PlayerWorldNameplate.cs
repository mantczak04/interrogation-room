...
public sealed class PlayerWorldNameplate : MonoBehaviour
{
    ...
    private PlayerGameplayController owner;
    ...
    private static void RegisterClientStartHook()
    {
        PlayerGameplayController.ClientStarted -= Attach;
        PlayerGameplayController.ClientStarted += Attach;
    }

    public static void Attach(PlayerGameplayController player)
    {
        if (player == null)
            return;
    ...
    private void Initialize(PlayerGameplayController player)
    {
        owner = player;
    ...
    {
        PlayerGameplayController localPlayer = NetworkClient.localPlayer != null
            ? NetworkClient.localPlayer.GetComponent<PlayerGameplayController>()
            : null;
